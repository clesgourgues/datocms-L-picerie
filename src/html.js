  ...
  return (
    <html {...props.htmlAttributes}>
      <head>
        ...
        <meta
          name='viewport'
          content='width=device-width, height=device-height, initial-scale=1, minimum-scale=1,  maximum-scale=1.0, shrink-to-fit=no,  user-scalable=no, target-densitydpi=device-dpi'
        />
      ...
      <body {...props.bodyAttributes}>
        ...
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5HLMJ5D" height="0" width="0"
